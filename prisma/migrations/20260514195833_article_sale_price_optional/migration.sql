...
INSERT INTO "new_Part" ("active", "brand", "categoryId", "createdAt", "description", "id", "location", "name", "oemReference", "purchasePriceHt", "reference", "reorderThreshold", "salePriceHt", "stockQty", "supplierId", "updatedAt", "vatRate") SELECT "active", "brand", "categoryId", "createdAt", "description", "id", "location", "name", "oemReference", "purchasePriceHt", "reference", "reorderThreshold", "salePriceHt", "stockQty", "supplierId", "updatedAt", "vatRate" FROM "Part";
DROP TABLE "Part";
